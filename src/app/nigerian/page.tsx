      ...
      <div className="container py-8">
        ...
        <Tabs defaultValue="grid" className="w-full">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-semibold">30 Nigerian Dishes</h2>
            <TabsList>
                ...
                <Card key={i} className="overflow-hidden">
                  ...
                  <div className="p-4">
                    ...
                    <Button asChild size="sm">
                      <Link href="/nigerian/jollof-rice">View Plating Ideas</Link>
                    </Button>
                  </div>
                </Card>
              ))}
                ...
                <Card key={i} className="overflow-hidden">
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="p-4 flex-1">
                      <h3 className="font-semibold text-lg">Jollof Rice</h3>
                      <p className="text-sm text-muted-foreground mb-3">
                        A flavorful rice dish cooked with tomatoes and spices. Popular at parties and celebrations across West Africa.
                      </p>
                      <Button asChild size="sm">
                        <Link href="/nigerian/jollof-rice">View Plating Ideas</Link>
                      </Button>
